...
#define PWM_CLOCK_DIVIDER 8500
#define CURRENT_LOOP_CLOCK_DIVIDER 4
#define DEBUG_LOOP_CLOCK_DIVIDER 200
#define ENCODER_PULSES_PER_ROTATION 8192
#define PWM_FREQUENCY (CLOCK_FREQUENCY/PWM_CLOCK_DIVIDER)
