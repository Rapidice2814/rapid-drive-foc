...
#define SPEED_LOOP_CLOCK_DIVIDER 8
...
#define Thermistor1_Pin GPIO_PIN_4
#define Thermistor1_GPIO_Port GPIOA
#define Thermistor2_Pin GPIO_PIN_5
#define Thermistor2_GPIO_Port GPIOA
#define PWM_AUX_Pin GPIO_PIN_6
#define PWM_AUX_GPIO_Port GPIOA
...
#define DEBUG_LED0_Pin GPIO_PIN_1
#define DEBUG_LED0_GPIO_Port GPIOB
#define PB2_Pin GPIO_PIN_2
#define PB2_GPIO_Port GPIOB
#define AS_NCS_EXT_Pin GPIO_PIN_11
#define AS_NCS_EXT_GPIO_Port GPIOB
